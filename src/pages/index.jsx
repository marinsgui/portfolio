      ...
      <main name="home" className='h-screen bg-gradient-to-b from-black via-black to-gray-800 text-white md:pt-24'>
        <div className='max-w-screen-lg mx-auto flex flex-col justify-center items-center px-4 md:flex-row gap-24'>
          <div className='flex flex-col justify-center h-full max-w-md'>
            <h2 className='text-4xl sm:text-7xl font-bold text-white'>Sou um desenvolvedor front-end</h2>
            <p className='text-gray-500 py-4'>Desenvolvedor Front-End. Possuo conhecimento em HTML, CSS, JavaScript, React e outras tecnologias da web. Sou apaixonado por design e UX, e busco sempre criar soluções atraentes e intuitivas para o usuário.
            ...
            Estou sempre buscando me atualizar e aprender com as últimas tendências e tecnologias do mercado.</p>
